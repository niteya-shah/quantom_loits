...
std::vector<at::Tensor> forward(at::Tensor x_bins,
  ...
  const loits::Shape s{x_bins.size(0), x_bins.size(1), q_bins.size(1), x_bins.size(2), q_bins.size(2),
                           x_bins.size(1) * q_bins.size(1)};

  at::Tensor counts;
  loits::Allocation allocation{};
  {
    ...
    allocation = loits::allocate_counts(weights.data_ptr<double>(), counts.data_ptr<int64_t>(), n_events, s);
  }
  ...
  at::Tensor rho_x;
  {
    ...
    loits::density_x(x_bins.data_ptr<double>(), xsec_x.data_ptr<double>(), norm_x.data_ptr<double>(), rho_x.data_ptr<double>(), s);
  }
  ...
  at::Tensor rho_q;
  {
    ...
    loits::density_q(q_bins.data_ptr<double>(), xsec_q.data_ptr<double>(), norm_q.data_ptr<double>(), rho_q.data_ptr<double>(), s);
  }
  ...
  at::Tensor cdf_x;
  {
    ...
    loits::cdf_x(x_bins.data_ptr<double>(), rho_x.data_ptr<double>(), acceptance.data_ptr<bool>(), cdf_x.data_ptr<double>(), s);
  }
  ...
  at::Tensor cdf_q;
  {
    ...
    loits::cdf_q(q_bins.data_ptr<double>(), rho_q.data_ptr<double>(), acceptance.data_ptr<bool>(), cdf_q.data_ptr<double>(), s);
  }
  ...
  at::Tensor u_q;
  {
    ...
    loits::fill_uniform(u_x.data_ptr<float>(), total_slots, seed, sequence * 2);
  }
  {
    RegionGuard region(profile_regions, "loits::forward::random_q2");
    u_q = at::empty({s.batch, s.cells, allocation.nmax}, random_options);
    loits::fill_uniform(u_q.data_ptr<float>(), total_slots, seed, sequence * 2 + 1);
  }
  ...
  at::Tensor interval_x;
  {
    ...
    loits::interpolate_x(x_bins.data_ptr<double>(), cdf_x.data_ptr<double>(), u_x.data_ptr<float>(), counts.data_ptr<int64_t>(),
  ...
  at::Tensor interval_q;
  {
    ...
    loits::interpolate_q(q_bins.data_ptr<double>(), cdf_q.data_ptr<double>(), u_q.data_ptr<float>(), counts.data_ptr<int64_t>(),
  ...
  at::Tensor packed;
  {
    ...
    const int64_t valid = loits::compact(dense_x.data_ptr<double>(), dense_q.data_ptr<double>(), counts.data_ptr<int64_t>(),
                                         allocation.nmax, events_storage.data_ptr<double>(), packed_storage.data_ptr<int64_t>(), s);
...

  {
    ...
    return {events, norm_x, norm_q, cdf_x, cdf_q, u_x, u_q, interval_x, interval_q, packed};
  }
}
...
std::vector<at::Tensor> backward(at::Tensor grad_events,
  ...
  at::Tensor grad_cdf_x;
  {
    ...
    loits::interpolation_vjp_x(grad_events.data_ptr<double>(), packed.data_ptr<int64_t>(), packed.size(0), x_bins.data_ptr<double>(),
                               cdf_x.data_ptr<double>(), u_x.data_ptr<float>(), interval_x.data_ptr<int16_t>(), nmax,
                               grad_cdf_x.data_ptr<double>(), s);
  }
  ...
  at::Tensor grad_cdf_q;
  {
    ...
    loits::interpolation_vjp_q(grad_events.data_ptr<double>(), packed.data_ptr<int64_t>(), packed.size(0), q_bins.data_ptr<double>(),
                               cdf_q.data_ptr<double>(), u_q.data_ptr<float>(), interval_q.data_ptr<int16_t>(), nmax,
                               grad_cdf_q.data_ptr<double>(), s);
  }
  ...
  at::Tensor grad_rho_x;
  {
    ...
    loits::cdf_vjp_x(x_bins.data_ptr<double>(), acceptance.data_ptr<bool>(), grad_cdf_x.data_ptr<double>(),
  ...
  at::Tensor grad_rho_q;
  {
    ...
    loits::cdf_vjp_q(q_bins.data_ptr<double>(), acceptance.data_ptr<bool>(), grad_cdf_q.data_ptr<double>(),
  ...
  at::Tensor grad_xsec_x;
  {
    ...
    loits::density_vjp_x(x_bins.data_ptr<double>(), xsec_x.data_ptr<double>(), norm_x.data_ptr<double>(), grad_rho_x.data_ptr<double>(),
  ...
  at::Tensor grad_xsec_q;
  {
    ...
    loits::density_vjp_q(q_bins.data_ptr<double>(), xsec_q.data_ptr<double>(), norm_q.data_ptr<double>(), grad_rho_q.data_ptr<double>(),
